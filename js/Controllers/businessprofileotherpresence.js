angular.module('businessprofileotherpresence.controllers', [])
.controller('BusinessProfileOtherpresenceCtrl', function($scope, APIService, $state, SweetAlert) {
    ...
    $scope.editOtherNetwork = function(value){
        // $scope.isOtherNetworkupdate = true;
        // if(value){
        //     $scope.addOtherNetworkform = value;
        // }else{
        //     $scope.addOtherNetworkform = {};
        // }
        
        $('.other-network').modal('show');
    }
});