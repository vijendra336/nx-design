angular.module('businessprofileotheroverview.controllers', [])
.controller('BusinessProfileOtheroverviewCtrl', function($scope, APIService, $state, SweetAlert, $location) {
    ...
    $scope.photoscarouselInitializer = function() {
        $("#dashboard-photos-slider").owlCarousel({
            autoPlay: 4000,
            center: true,
    ...
    $scope.videoscarouselInitializer = function() {
        $("#dashboard-videos-slider").owlCarousel({
            autoPlay: 4000,
            center: true,
            loop:true,lazyLoad: true,
            nav:true,
    ...
    $scope.blogscarouselInitializer = function() {
        $("#dashboard-blogs-slider").owlCarousel({
            autoPlay: 4000,
            center: true,
            nav:true,
            loop:true,lazyLoad: true,
