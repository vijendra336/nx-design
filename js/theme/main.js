...
(function ($) {
	...
	var $window = $(window),
		...
		$document.ready(function() {
			var height = Number($(window).height())-156;
			console.log(height);
			//("pageBody").style.backgroundColor = height+"px";
            $('#pageBody').css("min-height", height+"px");
            $('#messageBody').css("height", Number(Number(height)+90)+"px");
        });
    ...
    CRUMINA.Bootstrap = function () {
         ...
         * https://v4-alpha.getbootstrap.com/getting-started/introduction
         * ---------------------------*/
    //     var date_select_field = $('.date-time-picker-input');
    //     var start = moment().subtract(29, 'days');
    //     console.log(start);
    //     var d = new Date(new Date().setFullYear(new Date().getFullYear() - 15));
    //     var dm = new Date(new Date().setFullYear(new Date().getFullYear() - 120));
    ...
    $(".left-sidebar-open").on('click', function () {
        console.log('dsdaasasas');
        $('#sidebar-left-responsive .left-sidebar-open').toggleClass('active');
        $('.fixed-sidebar.left').toggleClass('open');
        return false;
    } );
    ...
    $window.keydown(function (eventObject) {
        if (eventObject.which == 27 && $sidebar.is(':visible')) {
            ...
            $('#sidebar-left-responsive .left-sidebar-open.active').removeClass('active');
        }
    });
